...
#define CURRENTCOMMANDOFFSET 0x16E8 // 0x332C ????
...
//#define SKINS_OFFSET_PAINTKIT 0x3160;//m_nFallbackPaintKit
//#define SKINS_OFFSET_WEAR 0x3168;//m_flFallbackWear
//#define SKINYouS_OFFSET_STATTRAK 0x316C;//m_nFallbackStatTrak
//#define SKINS_OFFSET_ACCID 0x2FA0;//m_iAccountID (AttributeManager + Item + AccountID = 2FA0, calculated in HEX)
//#define SKINS_OFFSET_ITEMIDHIGH 0x2F98;//m_iItemIDHigh (AttributeManager + Item + ItemIDHigh = 2F98, calculated in HEX)
//#define SKINS_OFFSET_ITEMIDLOW 0x2F9;//m_iItemIDLow (AttributeManager + Item + ItemIDLow = 2F9C, calculated in HEX)
//#define SKINS_OFFSET_WEAPONID 0x2D70 + 0x40 + 0x1D0;//m_AttributeManager + m_Item + m_iItemDefinitionIndex
//#define SKINS_OFFSET_ENTQUALITY 0x2F84;//m_iEntityQuality
