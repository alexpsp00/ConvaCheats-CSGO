...
#define JOYSTICK_AXIS_BUTTON( _joystick, _button ) ( (ButtonCode_t)JOYSTICK_AXIS_BUTTON_INTERNAL( _joystick, _button ) )
	...
	enum ButtonCode_t
	{
		...
		JOYSTICK_LAST_BUTTON = JOYSTICK_BUTTON_INTERNAL(0, JOYSTICK_MAX_BUTTON_COUNT - 1),
		JOYSTICK_FIRST_POV_BUTTON,
		JOYSTICK_LAST_POV_BUTTON = JOYSTICK_POV_BUTTON_INTERNAL(0, JOYSTICK_POV_BUTTON_COUNT - 1),
		JOYSTICK_FIRST_AXIS_BUTTON,
		JOYSTICK_LAST_AXIS_BUTTON = JOYSTICK_AXIS_BUTTON_INTERNAL(0, JOYSTICK_AXIS_BUTTON_COUNT - 1),
	...
	public:
		...
		{
			typedef void(__thiscall* SetStringFn)(void*, const char*);
			return getvfunc<SetStringFn>(this, 13)(this, str);
		}

		void InternalSetString(const char* str)
		{
			typedef void(__thiscall* SetStringFn)(void*, const char*);
			return getvfunc<SetStringFn>(this, 17)(this, str);
		}

		char* GetBaseName()
		{
			typedef char*(__thiscall* SetStringFn)(void*);
			return getvfunc<SetStringFn>(this, 6)(this);
		}
