...
public:
	...
	int GetTickBase()
	{
		static int iOffset = g_NetworkedVariableManager.GetOffset("DT_CSPlayer", "m_nTickBase");
	...
	int GetArmor()
	{
		static int iOffset = g_NetworkedVariableManager.GetOffset("DT_CSPlayer", "m_ArmorValue");
		return *(int*)((DWORD)this + iOffset);
	}

	int GetCash()
	{
		static int iOffset = g_NetworkedVariableManager.GetOffset("DT_CSPlayer", "m_iAccount");
		return *(int*)((DWORD)this + iOffset);
	}
	...
	{
		static int iOffset = g_NetworkedVariableManager.GetOffset("DT_BasePlayer", "m_aimPunchAngle"); // m_aimPunchAngle is punchangle for csgo.
	...
	{
		static int iOffset = g_NetworkedVariableManager.GetOffset("DT_CSPlayer", "m_bGunGameImmunity");
		return *(bool*)((DWORD)this + iOffset);
	}
