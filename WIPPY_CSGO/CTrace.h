...
namespace ValveSDK
{
	...
	public:
		...
		DWORD GetPointContents(Vector* Point, DWORD Flags, void* a3)
		{
			typedef DWORD(__thiscall* TraceRay_t)(PVOID, Vector*, DWORD, void*);
			//VTable::CallVirtualFunction< TraceRay_t >(this, VTABLE_TRACERAY)(this, ray, iMask, pTraceFilter, pTrace);
			return getvfunc<TraceRay_t>(this, VTABLE_GETPOINTCONTENTS)(this, Point, Flags, a3);
		}
		/************************************************************************/
